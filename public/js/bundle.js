      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); //! found in axios documentation
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXdzc25hZmVhIiwiYSI6ImNrejQ2enJvbTAxamoyb3F3d29qNGh6dDAifQ.Gy6zYS7b98GiGBZzruyKag';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/awssnafea/ckz4a192g000n15oiwrzsjit3',
    scrollZoom: false //   center: [36.332697, 41.31656],
    //   zoom: 10,
    //   interactive: false,
...
var userPassForm = document.querySelector('.form-user-settings'); //Values
//Delegation
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form);
  var email = document.getElementById('email').value;
  var name = document.getElementById('name').value; // updateSettings({ name, email }, 'data'); before photo upload sitting

  (0, _updateSettings.updateSettings)(form, 'data');
});
if (userPassForm) userPassForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            document.getElementById('password-confirm').value = '', _readOnlyError("passwordConfirm");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1811" + '/');
